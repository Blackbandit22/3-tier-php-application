...
# Copy the Apache2 Proxy Config File From S3 (using the Objects URI)
sudo rm /etc/apache2/sites-available/000-default.conf
sudo aws s3 cp s3://prod-proxy-app-db-config-meck/000-default.conf /etc/apache2/sites-available/
